...
- Admin
    - Nhiệm vụ
        ...
        + Xem thống kê commit GitHub của các nhóm.
    - Quyền hạn
...
- Team leader
    + Nhiệm vụ
        ...
        + Xem thống kê commit GitHub của toàn nhóm.
    + Quyền hạn
        + Chỉ được quản lý các nhóm được phân công
        + Chỉ có quyền xem dữ liệu và báo cáo
        + Không được quản lý Requirement, Task hoặc cấu hình hệ thống
- Team Member
    + Nhiệm vụ
        ...
        + Xem thống kê commit của bản thân.
    + Quyền hạn
...
| Cấu hình tích hợp Jira             |   Y   |    N     |      N     |      N      |
| Cấu hình tích hợp GitHub           |   Y   |    N     |      N     |      N      |
| Xem Requirement                    |   N   |    Y     |      Y     |      N      |
| Quản lý Requirement (Thêm/Sửa/Xóa) |   N   |    N     |      Y     |      N      |
| Xem Task                           |   N   |    Y     |      Y     |      Y      |
| Tạo Task                           |   N   |    N     |      Y     |      N      |
| Sửa Task                           |   N   |    N     |      Y     |      N      |
| Xóa Task                           |   N   |    N     |      Y     |      N      |
...
| Theo dõi tiến độ dự án             |   Y   |    Y     |      Y     |      N      |
...
| Xem thống kê commit cá nhân        |   N   |    N     |     N      |      Y      |
