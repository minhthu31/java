...
public class GitHubConnectionTestResponse {
    ...
    public Instant getRateLimitResetAt() { return rateLimitResetAt; }
    public void setRateLimitResetAt(Instant rateLimitResetAt) { this.rateLimitResetAt = rateLimitResetAt; }
    ...
    public static class Builder {
        ...
        public Builder githubRepositoryId(Long githubRepositoryId) { this.githubRepositoryId = githubRepositoryId; return this; }
        ...
        public Builder rateLimitRemaining(Long rateLimitRemaining) { this.rateLimitRemaining = rateLimitRemaining; return this; }
        public Builder rateLimitResetAt(Instant rateLimitResetAt) { this.rateLimitResetAt = rateLimitResetAt; return this; }
        public Builder testedAt(Instant testedAt) { this.testedAt = testedAt; return this; }

        public GitHubConnectionTestResponse build() {
            return new GitHubConnectionTestResponse(projectId, connected, githubUserId, login,
                    githubRepositoryId, repositoryFullName, permission, rateLimitRemaining, rateLimitResetAt, testedAt);
        }
    }
}